#!/bin/bash
# Script to update icon files in the S3 bucket
...
echo "Upload complete! Your browser tab icon should now be updated."
echo "Note: You may need to clear your browser cache to see the changes immediately." 